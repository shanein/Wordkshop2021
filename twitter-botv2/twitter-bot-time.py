...
# i : variable pour lister le nombre de poste envoyé sur la console
i = 1

#boucle pour envoyer automatiquement des postes en fonction du temps
while True:
    ...
    print("Le Tweet a bien été posté ", i)
    i+=1
    #10 minutes entre chaque poste
    time.sleep(600)
